  ...
  !function(e, t) {
    ...
    function f(e, t, n) {
      function r(t, n) {
        ...
        var _,
            ...
            E = m[B(i)] = m[i],
            S = m[B(s)] = m[s];
        n && n.prepend && (_ = m[B(n.prepend)] = m[n.prepend]);
        var D = function() {
          if (!b.isExisting)
                ...
                if (!d || d(t, u, c, arguments)) {
                  ...
                  if (_)
                    ...
                    var T = p + q,
                        ...
                        E = A + T,
                        S = A + w;
                    oe[p] = {}, oe[p][q] = E, oe[p][F] = S, k = v ? S : E;
                  }
                  var D = c[k],
                      Z = !1;
                  if (D) {
                  ...
                  var z,
                      ...
                      P = ae[O];
                  P && (z = P[p]), z || (z = O + n + p), b.options = f, g && (b.options.once = !1), b.target = c, b.capture = v, b.eventName = p, b.isExisting = Z;
                  var j = r ? re : null;
                  j && (j.taskData = b);
                  var C = m.scheduleEventTask(z, u, j, o, a);
                  return b.target = null, j && (j.taskData = null), g && (f.once = !0), C.options = f, C.target = c, C.capture = v, C.eventName = p, l && (C.originalDelegate = u), s ? D.unshift(C) : D.push(C), i ? c : void 0;
                }
              };
            };
        return m[o] = H(T, u, j, I, k), _ && (m[p] = H(_, f, O, I, k, !0)), m[a] = function() {
          var t,
              n = this || e,
              r = arguments[0],
              o = arguments[2];
            ...
            if (r) {
              ...
              if (c)
                for (var l = c.slice(),
                  ...
                  this[a].call(this, n, h, f.options);
                }
              if (u)
                for (var l = u.slice(),
                    p = 0; p < l.length; p++) {
        ...
        }, l(m[o], T), l(m[a], w), S && l(m[s], S), E && l(m[i], E), !0;
      }
      for (var o = n && n.add || M,
          a = n && n.rm || R,
      ...
      s = c(e, n, function(r) {
        return function(s, c) {
          if ("function" == typeof c[0]) {
            ...
            return "number" == typeof f ? l[f] = p : f && (f[ce] = p), f && f.ref && f.unref && "function" == typeof f.ref && "function" == typeof f.unref && (p.ref = f.ref.bind(f), p.unref = f.unref.bind(f)), "number" == typeof f || f ? f : p;
          }
          return r.apply(e, c);
        };
      }), u = c(e, r, function(t) {
    ...
    function g() {
      Object.defineProperty = function(e, t, n) {
        ...
        return "prototype" !== t && (n = m(e, t, n)), _(e, t, n, r);
    ...
    function k(e, t) {
      return e && e[fe] && e[fe][t];
    }
    function m(e, t, n) {
      return Object.isFrozen(n) || (n.configurable = !0), n.configurable || (e[fe] || Object.isFrozen(e) || ue(e, fe, {
        writable: !0,
        value: {}
      }), e[fe] && (e[fe][t] = !0)), n;
    }
    ...
    function Z(e, t) {
      ...
      return f(e, D, {vh: S}), t.patchEventTarget = f, !0;
    }
    function z(e, t) {
      d(e, t);
    }
    ...
    (function(e) {
      ...
      function r(t) {
        0 === I && 0 === y.length && (l || e[v] && (l = e[v].resolve(0)), l ? l[g](o) : e[d](o, 0)), t && y.push(t);
      }
      function o() {
        if (!k) {
          for (k = !0; y.length; ) {
    ...
    Zone.__load_patch("ZoneAwarePromise", function(e, t, n) {
      ...
      function u(e, o, a) {
        ...
        if (e[T] === S) {
          ...
          if (o !== Z && a instanceof L && a.hasOwnProperty(T) && a.hasOwnProperty(w) && a[T] !== S)
            l(a), u(e, a[T], a[w]);
          else if (o !== Z && "function" == typeof s)
            try {
            ...
            e[T] = o;
            var h = e[w];
            if (e[w] = a, o === Z && a instanceof Error) {
            ...
            if (0 == h.length && o == Z) {
              ...
              try {
                ...
                var k = f;
                k.rejection = a, k.promise = e, k.zone = t.current, k.task = t.currentTask, y.push(k), n.scheduleMicroTask();
              }
            }
          }
        }
      ...
      function p(e, t, n, r, o) {
        l(e);
        var a = e[T] ? "function" == typeof r ? r : i : "function" == typeof o ? o : s;
        t.scheduleMicroTask(E, function() {
          try {
            u(n, !0, t.run(a, void 0, [e[w]]));
          } catch (r) {
            u(n, !1, r);
          }
        });
      ...
      function f(e) {
        var t = e.prototype,
            n = t.then;
        t[m] = n;
        var r = d(e.prototype, "then");
        r && r.writable === !1 && r.configurable && v(e.prototype, "then", {writable: !0}), e.prototype.then = function(e, t) {
          var r = this,
      ...
      var b = g("unhandledPromiseRejectionHandler"),
          ...
          C = g("rejectionHandledHandler"),
          I = "function ZoneAwarePromise() { [native code] }",
          L = function() {
            function e(t) {
              var n = this;
              if (!(n instanceof e))
            ...
            return e.toString = function() {
              ...
              var r = new this.constructor(null),
                  o = t.current;
              return this[T] == S ? this[w].push(o, r, e, n) : p(this, o, r, e, n), r;
      ...
      H && !H.configurable || (H && delete H.writable, H && delete H.value, H || (H = {
        ...
        t === L ? e[R] = t : (e[k] = t, t.prototype[m] || f(t), n.setNativePromise(t));
      }, v(e, "Promise", H)), e.Promise = L;
      var x = g("thenPatched");
      if (M) {
        f(M);
        var F = e.fetch;
        "function" == typeof F && (e.fetch = h(F));
      }
      return Promise[t.__symbol__("uncaughtPromiseErrors")] = y, L;
    });
    var P = Object.getOwnPropertyDescriptor,
        ...
        te = !1,
        ne = !1;
    Zone.__load_patch("toString", function(e, t) {
      var n = t.__zone_symbol__originalToString = Function.prototype.toString,
          r = B("OriginalDelegate"),
          o = B("Promise"),
          a = B("Error");
      Function.prototype.toString = function() {
        if ("function" == typeof this) {
          var t = this[r];
          if (t)
            return "function" == typeof t ? n.apply(this[r], arguments) : Object.prototype.toString.call(t);
          if (this === Promise) {
            var i = e[o];
            if (i)
    ...
    var re = {useG: !0},
        ...
        ze = ["error", "message"],
        Oe = he.concat(me, _e, be, de, ve, ge, ke),
        Pe = B("unbound");
