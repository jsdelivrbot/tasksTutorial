 ...
 while (0 < n);
        ...
        b.prototype._serializeMappings = function() {
          for (var a = 0,
            ...
            if (y.generatedLine !== b)
              ...
              if (!k.compareByGeneratedPositionsInflated(y, C[v - 1]))
                continue;
              m += ",";
            }
            m += e.encode(y.generatedColumn - a);
            a = y.generatedColumn;
            null != y.source && (D = this._sources.indexOf(y.source), m += e.encode(D - q), q = D, m += e.encode(y.originalLine - 1 - h), h = y.originalLine - 1, m += e.encode(y.originalColumn - d), d = y.originalColumn, null != y.name && (y = this._names.indexOf(y.name), m += e.encode(y - n), n = y));
            c += m;
          }
          return c;
        };
      ...
      16: [function(q, v, h) {
        ...
        b.fromStringWithSourceMap = function(d, a, e) {
          ...
          q < t.length && (D && l(D, c()), h.add(t.splice(q).join("")));
          a.sources.forEach(function(b) {
            var c = a.sourceContentFor(b);
      ...
      19: [function(q, v, h) {
        (function(b, e) {
          ...
          function d(a, b) {
            ...
            return d && /^\/\w:/.test(e) ? (d += "/", d + D.resolve(c.slice(d.length), b).replace(/\\/g, "/")) : d + D.resolve(c.slice(d.length), b);
          }
          function a(a) {
            var b = G[a.source];
            if (!b) {
          ...
          function c(a) {
            ...
            if (b) {
              ...
              b = +b[3];
              var d = B[a];
              if (!d && C && C.existsSync(a))
                try {
                  d = C.readFileSync(a, "utf8");
                } catch (w) {
                  d = "";
                }
              if (d && (d = d.split(/(?:\r\n|\r|\n)/)[c - 1]))
          ...
          try {
            var C = q("fs");
            C.existsSync && C.readFileSync || (C = null);
          } catch (I) {}
          var M = !1,
              K = !1,
              L = !1,
          ...
          A.push(function(a) {
            ...
            } else if (C.existsSync(a))
              try {
                b = C.readFileSync(a, "utf8");
              } catch (g) {
                b = "";
              }
            return B[a] = b;
