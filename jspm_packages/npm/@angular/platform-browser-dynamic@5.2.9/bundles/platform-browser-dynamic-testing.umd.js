...
(function(global, factory) {
  ...
  var COMPILER_PROVIDERS = [{
    provide: _angular_compiler_testing.MockPipeResolver,
    deps: [_angular_compiler.CompileReflector]
  }, {
    provide: _angular_compiler.PipeResolver,
    useExisting: _angular_compiler_testing.MockPipeResolver
  }, {
    provide: _angular_compiler_testing.MockDirectiveResolver,
    deps: [_angular_compiler.CompileReflector]
  }, {
    provide: _angular_compiler.DirectiveResolver,
    useExisting: _angular_compiler_testing.MockDirectiveResolver
  }, {
    provide: _angular_compiler_testing.MockNgModuleResolver,
    deps: [_angular_compiler.CompileReflector]
  }, {
    provide: _angular_compiler.NgModuleResolver,
    useExisting: _angular_compiler_testing.MockNgModuleResolver
  }];
  ...
  var TestingCompilerImpl = (function() {
    ...
    TestingCompilerImpl.prototype.getComponentFromError = function(error) {
      return ((error))[_angular_compiler.ERROR_COMPONENT_TYPE] || null;
    };
  ...
  var platformCoreDynamicTesting = _angular_core.createPlatformFactory(_angular_platformBrowserDynamic.ɵplatformCoreDynamic, 'coreDynamicTesting', [{
    ...
    useValue: {providers: COMPILER_PROVIDERS},
    multi: true
  }, {
